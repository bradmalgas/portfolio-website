          ...
          <div className="absolute inset-0 -z-10 overflow-hidden">
              <div
                  ...
                  style={{
                      ...
                      height: "120%",
                      background: `
                        radial-gradient(circle at 18% 22%, rgb(var(--color-accent-rgb) / 0.28), transparent 0 26%),
                        radial-gradient(circle at 82% 18%, rgb(var(--color-surface-overlay-rgb) / 0.82), transparent 0 28%),
                        radial-gradient(circle at 52% 100%, rgb(var(--color-accent-rgb) / 0.12), transparent 0 34%),
                        linear-gradient(135deg, rgb(var(--color-surface-rgb) / 0.98) 0%, rgb(var(--color-background-rgb) / 0.90) 46%, rgb(var(--color-surface-raised-rgb) / 0.94) 100%)
                      `,
                  }}
              />
              <div
